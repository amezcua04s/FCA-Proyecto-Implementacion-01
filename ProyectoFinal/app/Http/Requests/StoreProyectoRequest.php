...
class StoreProyectoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'inicio.required' => 'Se esperaba una fecha inicial',
            'inicio.date' => 'Se esperaba una fecha',
            'fin.required' => 'Se esperaba una fecha final',
            'fin.date' => 'Se esperaba una fecha',
            'fin.after_or_equal' => 'Se esperaba una fecha igual o después a la fecha inicial',
